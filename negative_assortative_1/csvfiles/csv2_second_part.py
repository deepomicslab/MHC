                ...
                for filename in filenames:
                    if filename.startswith("pos_prob_split_"+chr+"_"):
                        ...
                        if allrigion_P_top_1000:
                            ...
                            pvalue=round(stats.norm.cdf(mean_100_P, all_mean_arr, all_std_arr),15)
                            onerecord=[]
                ...
                for filename in filenames:
                    if filename.startswith("split_"+chr+"_"):
                        ...
                        if allrigion_P_top_1000:
                            mean_100_P=np.mean(allrigion_P_top_1000)
                            std_100_P=np.std(allrigion_P_top_1000, ddof=1)
                            pvalue=round(stats.norm.cdf(mean_100_P,mean_dict_different_race[record[1]],std_dict_different_race[record[1]]),15)
...
def generatedf(columns,allrecords):
    ...
    dataframe(dictforDF).to_csv("/data2/wangxuedong/mhc_test_data/similarity_region_pythonfiles/csvfiles/csv2_second_part_python_file.csv")
...
dfnew.to_csv("/data2/wangxuedong/mhc_test_data/similarity_region_pythonfiles/csvfiles/csv2_with_corr.csv")