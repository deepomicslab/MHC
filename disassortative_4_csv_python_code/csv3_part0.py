...
def generatedf(columns,allrecords):
    ...
    dataframe(dictforDF).to_csv("csv3new_05_11_without_correct_pvalue.csv")
...
dfnew.to_csv("/data2/wangxuedong/mhc_test_data/python/newrequirements/csv3_again_new_05_11.csv")
